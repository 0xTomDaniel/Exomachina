...
PRIOR_COMMON = HERE.parents[1] / "decision-round" / "common"
S2_PYTHON = HERE.parents[1] / "s2" / ".venv" / "bin" / "python"
SERVICE_PORTS = {"source": 35561, "counter": 35562, "quality": 35563,
                 "release": 35564, "opaque": 35565, "director": 35566}
...
def start_service(name: str, state: Path) -> subprocess.Popen:
    ...
    if name in {"source", "counter"}:
        script = PRIOR_COMMON / "harness_server.py"
