...
COMMON = Path(__file__).resolve().parents[3] / "2026-09-22" / "decision-round" / "common"
sys.path.insert(0, str(COMMON))
import long_client as a2a  # noqa: E402
sys.path.insert(0, str(Path(__file__).resolve().parents[3] / "2026-09-22" / "arbitration" / "common"))
...
@activity.defn
async def synthesize_v2(input: dict) -> dict:
