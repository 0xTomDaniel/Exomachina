...
class FactoryRun:
    ...
    def status(self) -> dict:
        return {
            ...
            "output_shape": 2, "completed": self.completed, "child_id": self.child_id,
    ...
    async def run_node(self, document: dict, package: dict, input: dict) -> dict:
        ...
        while True:
            ...
            if kind == "parallel":
                ...
                self.current = await _activity(synthesize_v2, {
                ...
                try:
                    ...
                    return {"status": "expired", "run": self.run_id,
                            "definition_digest": self.definition_digest,
                            "revision": self.current["revision"], "released": False, "output_shape": 2}
                ...
                if child_result["status"] != "accepted":
                    ...
                    return {"status": child_result["status"], "run": self.run_id,
                            "definition_digest": self.definition_digest,
                            "child": child_result, "released": False, "output_shape": 2}
                ...
                return {"status": "accepted", "run": self.run_id,
                        ...
                        "output_shape": 2, "completed": self.completed,
