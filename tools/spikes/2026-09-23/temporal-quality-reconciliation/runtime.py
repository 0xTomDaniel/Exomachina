...
PORTS = {"postgres": 31401, "frontend": 44002, "http": 44003, "matching": 44004,
         "history": 44005, "worker": 44006, "front_member": 31407,
         "match_member": 31408, "history_member": 31409, "worker_member": 31410,
         "pprof": 44011, "metrics": 44012}
...
def start_worker() -> subprocess.Popen:
    env = dict(os.environ, EXO_TEMPORAL_ADDRESS=f"127.0.0.1:{PORTS['frontend']}",
               ...
               EXO_TQ_OUTCOME_DB=str(STATE / "a2a-outcomes.sqlite3"))
